          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Daily Email Limit (Batch Size)</label>
                  <div className="grid grid-cols-6 gap-2 max-w-lg">
                    {[5,10,15,20,30,50].map(v => (
                      <button
                        key={v}
                        type="button"
                        className={`px-3 py-2 border rounded-md text-sm transition-colors ${campaignData.scheduleSettings.dailyLimit === v ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-300 hover:border-gray-400'}`}
                        onClick={() => setCampaignData(prev => ({
                          ...prev,
                          scheduleSettings: { ...prev.scheduleSettings, dailyLimit: v }
                        }))}
                      >
                        {v}/day
                      </button>
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Choose how many emails to send per day. Smaller batches (5-10) are better for deliverability and email warmup.
                  </p>
                </div>
              </CardContent>
            </Card>
