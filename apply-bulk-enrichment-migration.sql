-- Run this SQL in your Supabase dashboard to enable bulk enrichment functionality
-- Go to: Supabase Dashboard > Your Project > SQL Editor > Run the following
...
DROP TRIGGER IF EXISTS update_bulk_enrichment_jobs_updated_at_trigger ON bulk_enrichment_jobs;
CREATE TRIGGER update_bulk_enrichment_jobs_updated_at_trigger
...
-- Create indexes on contacts enrichment fields
